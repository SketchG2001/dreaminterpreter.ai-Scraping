        ...
        for li_tag in li_tags[1:]:
            ...
            if anchor_tag:
                ...
                if link:
                    ...
                    specific_links = [
                        'https://dreaminterpreter.ai/dream-dictionary/o',
                        'https://dreaminterpreter.ai/dream-dictionary/p',
                        'https://dreaminterpreter.ai/dream-dictionary/q',
                        # Add more specific links as needed
                    ]

                    if complete_link in specific_links:
                        print(complete_link)
                        # sys.exit()
                        try:
                                                        ...
                                                        if dreams_list:
                                                            ...
                                                            if dreams_anchor:
                                                                ...
                                                                try:
                                                                    ...
                                                                    WebDriverWait(driver, 30).until(EC.presence_of_element_located((By.CLASS_NAME, 'Interpreter_dream_card_container__NWBLD')))
                                                                    end_time = time.time()
                                                                    loading_time = end_time - start_time
                                                                    print("Page loaded in", loading_time, "seconds")
                                                                except TimeoutException:
                        ...
                        print(f"Skipping link: {complete_link} as it is not in the list of specific links.")
